...
class SawyerPushAndReachCustomXYEnv(MujocoEnv, Serializable, MultitaskEnv):
    ...
    def model_name(self):
        return get_asset_full_path(
            'sawyer_xyz/sawyer_push_and_reach_mocap_goal_hidden_custom.xml'
        )
    ...
    def sample_puck_xy(self):
        raise NotImplementedError("Shouldn't you use "
                                  "SawyerPushAndReachXYCustomEasyEnv? Ask Vitchyr")
    ...
    @property
    def init_angles(self):
        return [7.41785263e-02, -7.20585802e-01, -8.23460749e-02,  2.29368814e+00,
                1.57884304e+00,  6.15733239e-02,  1.86230253e-01, 6.00000000e-01,
                2.85677223e-08, 1.59709553e-02, 9.99999990e-01, 2.97034307e-05,
                -3.78853123e-06, 1.38684526e-04, 5.93784630e-01, -2.77141525e-02,
                2.09686080e-02, 7.07106781e-01, 1.49737897e-14, 7.07106781e-01,
                -1.49974684e-14, 9.56819919e-03, 6.40711816e-01, -4.41544300e+01,
                1, 0.00000000e+00, 1, 0.00000000e+00,
                ]
...
class SawyerPushAndReachCustomXYEasyEnv(SawyerPushAndReachCustomXYEnv):
    """
    ...
    def __init__(
        ...
        SawyerPushAndReachCustomXYEnv.__init__(
            self,
            **actual_kwargs
        )
